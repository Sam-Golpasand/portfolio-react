...
export default function Navbar() {
  return (
    ...
    <div className="flex justify-center mt-4">
      <nav className=" flex navbar w-8/12 max-sm:w-full mx-2 bg-neutral text-neutral-content border-2 border-black rounded-full  backdrop-blur bg-black/40">
        ...
        <div className="flex-none space-x-2">
          ...
          <a href="/blog" className="btn btn-ghost max-sm:justify-self-center">Blog</a>
